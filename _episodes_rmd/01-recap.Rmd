...
> Compare the format of the co2 data (`data/co2_weekly_mlo.txt`) and the gapminder data [(`gapminder-FiveYearData.csv`)](gapminder-FiveYearData.csv).
...
[gapminder-FiveYearData.csv]: https://raw.githubusercontent.com/UoMResearchIT/r-tidyverse-intro/gh-pages/data/gapminder-FiveYearData.csv
