...
```
The first argument `demodata >= 5` returns a logical vector (`r demodata >= 5`).   If the nth element of the first argument is `TRUE`, the nth element of the second argument (`demodata + 1`) is returned.  If the nth element of the first argument is `FALSE`, the nth element of the third argument is returned (`-demodata`).
